...
Private Sub btnReadFileList_Click()
    Dim Arr() As String, i As Long, fso As New FileSystemObject, dataFn As String, sr As Object
    ...
    If fso.FileExists(dataFn) Then
        ...
        For i = LBound(Arr) To UBound(Arr)
            ...
            Else
                MsgBox "文件列表中 " & Chr(34) & Arr(i) & Chr(34) & " 文件读取失败,因为文件找不到!"
            End If
        Next
        MsgBox "成功读取文件列表"
    Else
...
Private Sub btnsaveList_Click()
    Dim fso As New FileSystemObject, var As Variant, ArrHelper As New BetterArray, col As New Collection, resArr As BetterArray
